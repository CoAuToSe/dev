...
class CameraFocus(Node):
    ...
    def _wait_for(self, future:str):
        for _ in range(10000):
            if future.done():
                return future.result()
            time.sleep(0.001)

    def compute_poses_maxima(self, eye:str):
    ...
    def compute_next_pose(self, eye: str, step: int):
        ...
        """
        if self.eyes_info[eye]['min_pos'] < self.eyes_info[eye]['pos'] + step and self.eyes_info[eye]['pos'] + step < self.eyes_info[eye]['max_pos']:
    ...
    def canny_sharpness_function(self, im:str):
    ...
    def on_image_update(self, msg:str, side:str):
    ...
    def focusing_algorithm(self, eye:str):
