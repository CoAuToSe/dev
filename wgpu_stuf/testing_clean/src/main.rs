...
impl Playground {
    ...
    pub fn run(opts: &Opts) {
        ...
        let mut playground = Playground {
            ...
            watch_path2: "C:\\Users\\Aurélien\\Documents\\dev\\wgpu_stuf\\wgsl-playground-main\\examples\\overlapping_circles.wgsl".into(),
            render_pipeline,
            window,
            device,
            swapchain_format,
            ...
            match event {
                ...
                winit::event::Event::RedrawRequested(_) => {
                    ...
                    if !internal_drawing {
                        ...
                        let output_frame = playground.surface.get_current_texture().unwrap();
